...
public class MonitoringService {
    ...
    /** Resets in-memory counters. Useful for the attack simulator. */
    ...
    /** Returns [{minute: "HH:mm", count: N}] for the last N minutes. */
    public List<Map<String, Object>> getRequestsPerMinute(int minutes) {
        ...
        // fill in zero-value minutes so the chart is continuous
