...
// DEMO APIs
export const callNormal = () => api.get('/api/normal').then(r => r.data).catch(e => ({ error: e.response?.status }))
export const callHeavy  = () => api.get('/api/heavy').then(r => r.data).catch(e => ({ error: e.response?.status }))
